//
//  SelectedDogsViewController.swift
//  Vdog
//
//  Created by tanut2539 on 11/12/2560 BE.
...
class SelectedDogsViewController: UICollectionViewController , UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        delegate?.userDidEnterInformation(info: Dog_Name[indexPath.row])
